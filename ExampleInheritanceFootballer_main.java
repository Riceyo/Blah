...
public class ExampleInheritanceFootballer_main {
	public static void main(String[] args) {
		...
		cb.Select(); // call overridden inherited method (polymorphism)
		...
		lb.Select(); // call overridden inherited method (polymorphism)
		...
		gk.Select(); // call overridden inherited method (polymorphism)
