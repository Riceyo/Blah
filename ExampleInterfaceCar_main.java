...
public class ExampleInterfaceCarCall {
	public static void main(String args[]) {
		...
		ExampleInterfaceCar AudiS3 = new ExampleInterfaceCarAudiS3(); // create another object from a different class constructor but again assign it reference variable of the interface
